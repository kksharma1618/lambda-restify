...
function triggerRequest(server: Server, customEventSource?: PartialEventSource, onResponse?, lamdaCallback?: LamdaCallback) {
    server.handleLamdaEvent(createEventSource(customEventSource), lamdaCallback || createLamdaCallback(onResponse))
}
...
describe('Server', function() {
    ...
    describe('version support', function() {
        it('should allow different version to coexist', function(done) {
